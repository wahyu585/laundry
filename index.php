            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><span> zafran Laundry </span></a>
                    </div>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <?php if ($hasil['level']=='Karyawan'||'Administrator') { ?>
                            <li>
                            ...
                            <li>
                                <a href="?p=tambahot" class="waves-effect"><i class="fa fa-user-plus"></i><span> Tambah Outlet </span></a>
                            </li>
							       <li class="has_sub">
							...
							<?php if ($hasil['level']=='Administrator') { ?>
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="?p=tambahk">Tambah Karyawan</a></li>
                                     ...
                                     <li><a href="?p=olahko">Olah Konsumen</a></li>
                                     <li><a href="?p=olahot">Olah outlet</a></li>
